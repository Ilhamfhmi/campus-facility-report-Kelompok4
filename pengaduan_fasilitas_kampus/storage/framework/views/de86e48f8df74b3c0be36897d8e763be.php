...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center mt-3">
                    <span>Sudah punya akun? <a href="<?php echo e(route('login')); ?>">Login di sini</a></span>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\campus-facility-report-Kelompok4\pengaduan_fasilitas_kampus\resources\views/auth/register.blade.php ENDPATH**/ ?>